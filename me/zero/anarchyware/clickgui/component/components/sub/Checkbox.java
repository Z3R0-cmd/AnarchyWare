...
public class Checkbox extends Component
{
    ...
    public void renderComponent() {
        ...
        Minecraft.func_71410_x().field_71466_p.func_175063_a(this.op.getDisplayName(), (float)((this.parent.parent.getX() + 10 + 4) * 2 + 5), (float)((this.parent.parent.getY() + this.offset + 2) * 2 + 4), -1);
        GL11.glPopMatrix();
    ...
    public void mouseClicked(final int mouseX, final int mouseY, final int button) {
        ...
        if (this.isMouseOnButton(mouseX, mouseY) && button == 0 && this.parent.open) {
            ...
            AnarchyWare.configManager.loadSettingsList();
        }
    }
