...
public class Keybind extends Component
{
    ...
    public void renderComponent() {
        ...
        Minecraft.func_71410_x().field_71466_p.func_175063_a(this.binding ? "Press a key..." : ("Key: " + Keyboard.getKeyName((int)this.parent.mod.getKey())), (float)((this.parent.parent.getX() + 7) * 2), (float)((this.parent.parent.getY() + this.offset + 2) * 2 + 5), -1);
        GL11.glPopMatrix();
    }
