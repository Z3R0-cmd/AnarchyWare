...
package me.zero.anarchyware.clickgui.component.components;
...
import me.zero.anarchyware.clickgui.component.components.sub.VisibleButton;
import me.zero.anarchyware.clickgui.component.components.sub.Keybind;
import me.zero.anarchyware.clickgui.component.components.sub.Checkbox;
import me.zero.anarchyware.clickgui.component.components.sub.Slider;
import me.zero.anarchyware.clickgui.component.components.sub.ModeButton;
...
public class Button extends Component
{
    ...
    public Button(final Module mod, final Frame parent, final int offset) {
        ...
        this.height = 12;
        int opY = offset + 12;
        if (AnarchyWare.settingsManager.getSettingsByMod(mod) != null) {
            for (final Setting s : AnarchyWare.settingsManager.getSettingsByMod(mod)) {
                if (s.isCombo()) {
    ...
    public void renderComponent() {
        ...
        Minecraft.func_71410_x().field_71466_p.func_175063_a(this.mod.getName(), (float)((this.parent.getX() + 2) * 2), (float)((this.parent.getY() + this.offset + 2) * 2 + 4), this.mod.isToggled() ? 10066329 : -1);
        ...
        if (this.open && !this.subcomponents.isEmpty()) {
            ...
            Gui.func_73734_a(this.parent.getX() + 2, this.parent.getY() + this.offset + 12, this.parent.getX() + 3, this.parent.getY() + this.offset + (this.subcomponents.size() + 1) * 12, ColorUtils.getRainbow());
        }
    }
